 ...
 * @author HP
 */
public class clientfinal extends javax.swing.JFrame implements Runnable {

    /**
     * Creates new form clientfinal
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("client Tic Tac Toe 'X'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clientfinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new clientfinal().setVisible(true);
            }
        });
    }
    ...
    private void processServerMessages() {
        while (true) {
            try {
                ...
                // String message2= (String )input2.readObject();
                switch (message) {
                    case 1:
